...
layout: home
title: ChaosNexus
description: "Sovereign, local-first agentic orchestration - Anvil engine + Forge IDE from Tuned Chaos. Contribute on Codeberg."

hero:
  name: "ChaosNexus"
  text: "Sovereign, local-first agentic orchestration"
  tagline: "Early alpha launch (pre-1.0) - Anvil engine + Forge IDE from Tuned Chaos. Contribute on Codeberg."
  image:
    src: /logo.svg
    alt: ChaosNexus Logo
  actions:
