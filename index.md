...
layout: home
title: ChaosNexus
description: "Sovereign, local-first agentic orchestration - Anvil engine + Forge IDE from Tuned Chaos. Contribute on GitHub."

hero:
  name: "ChaosNexus"
  text: "Sovereign, local-first agentic orchestration"
  tagline: "Early alpha launch (pre-1.0) - Anvil engine + Forge IDE from Tuned Chaos. Contribute on GitHub."
  image:
    src: /logo.svg
    alt: ChaosNexus Logo
  actions:
...
features:
  ...
  - title: Local models (in progress)
    ...
    link: /project_status_and_next_steps
  - title: Licensing
    details: AGPLv3-or-later for the community; commercial licenses available from Tuned Chaos.
    link: /guide/licensing
  - title: Roadmap
    details: Public milestones from GitHub repositories through 1.0 readiness.
    link: /roadmap
---
