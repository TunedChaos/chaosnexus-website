...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message: 'ChaosNexus is released under <a href="/guide/licensing">AGPL-3.0-or-later</a> (<a href="https://www.gnu.org/licenses/agpl-3.0.html" target="_blank" rel="noopener noreferrer">full text</a>). Third-party notices: <a href="/guide/attributions/">Attributions</a>. Contribute on <a href="https://codeberg.org/TunedChaos" target="_blank" rel="noopener noreferrer">Codeberg</a>.',
      copyright: 'Copyright © 2026 <a href="https://tunedchaos.com" target="_blank" rel="noopener noreferrer">Tuned Chaos</a> | <a href="https://tunedchaos.dev" target="_blank" rel="noopener noreferrer">Dev Blog</a> | <a href="/guide/support">Support</a>'
    },
    nav: [
      { text: 'Home', link: '/' },
