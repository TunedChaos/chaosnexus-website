...
**ChaosNexus Scripts** is the shared Rhai **plugins** and **libraries** tree consumed by ChaosNexus Anvil. In the workspace it lives at `chaosnexus-scripts/`. On GitHub it is the [chaosnexus-scripts](https://github.com/TunedChaos/chaosnexus-scripts) polyrepo ([also](https://github.com/TunedChaos/chaosnexus-scripts)).
...
Maintainer alpha-launch helpers live in the workspace at `tools/launch/` and are **not** part of this polyrepo.
...
AGPL-3.0-or-later (same as Anvil). See [Licensing](/guide/licensing) and [Scripts attributions](/guide/attributions/chaosnexus-scripts).
