...
If you already have the ChaosNexus workspace, the tree is at `chaosnexus-scripts/`. From `chaosnexus-anvil/`, the default probe is `../chaosnexus-scripts`.
...
```bash
git clone https://github.com/TunedChaos/chaosnexus-scripts.git
...
In ChaosNexus Forge, use **(O)** / open workspace and choose the `plugins` directory (or a parent Anvil recognizes as the scripts root). Defaults probe `../chaosnexus-scripts/plugins` in the workspace layout.
