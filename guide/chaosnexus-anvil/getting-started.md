...
If you do not specify a `--scripts-dir`, it will attempt to use a default `chaosnexus-scripts/` directory relative to the binary or your current working directory (workspace layout). Override with `scripts_dir` in host TOML.
