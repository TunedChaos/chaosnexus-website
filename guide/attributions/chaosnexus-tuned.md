...
ChaosNexus Tuned is the dataset, evaluation, and fine-tuning pipeline. Source code is **AGPL-3.0-or-later** (see `LICENSE` in [chaosnexus-tuned](https://github.com/TunedChaos/chaosnexus-tuned)).
