...
AGPL-3.0-or-later. See [Licensing](/guide/licensing), plus [Forge backend](/guide/attributions/chaosnexus-forge-backend) and [Forge frontend](/guide/attributions/chaosnexus-forge-frontend) attributions.
