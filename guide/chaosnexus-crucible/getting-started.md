...
Clone from the public GitHub host:

```bash
git clone https://github.com/TunedChaos/chaosnexus-crucible.git
cd chaosnexus-crucible
cargo build --release
```

In the ChaosNexus workspace the same tree is `chaosnexus-crucible/`.
