...
1. **Do NOT open a public issue** on GitHub or elsewhere for undisclosed security vulnerabilities.
...
Public discussion of already-fixed issues may use GitHub on the relevant TunedChaos repository.
